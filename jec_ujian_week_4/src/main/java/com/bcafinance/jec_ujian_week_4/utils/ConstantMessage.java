...
//    public final static String REGEX_EMAIL_STRICT = "^(?=.{1,64}@)[A-Za-z0-9_-]+(\\\\.[A-Za-z0-9_-]+)*@[^-][A-Za-z0-9-]+(\\\\.[A-Za-z0-9-]+)*(\\\\.[A-Za-z]{2,})$";
    ...
    */
    ...
    /*USER APPLICATION*/
    public final static String WARNING_USER_FULLNAME_MANDATORY = "NAMA WAJIB DIISI";
    public final static String WARNING_USER_EMAIL_MANDATORY = "EMAIL WAJIB DIISI";
    public final static String SUCCESS_REGISTRATION = "REGISTRASI BERHASIL";
    public final static String WARNING_USER_IS_EXISTS = "EMAIL SUDAH TERDAFTAR";
    public final static String WARNING_USER_NOT_FOUND = "USER BELUM TERDAFTAR";

    /*Ujian Week 4*/
    public final static String ERROR_TIDAK_BOLEH_KOSONG_CONSUMEN_ID = "CONSUMEN ID WAJIB DIISI";
    public final static String ERROR_TIDAK_BOLEH_KOSONG_INSTALLMENT = "INSTALLMENT WAJIB DIISI";
    public final static String ERROR_TIDAK_BOLEH_KOSONG_CAR_NAME = "CAR NAME WAJIB DIISI";
}
